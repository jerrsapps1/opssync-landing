    ...
    <span className="inline-block align-middle" style={{ width: px, height: px, lineHeight: 0 }}>
      <svg viewBox="0 0 64 64" width={size} height={size} role="img" aria-label={title}>
        ...
        <g transform="rotate(0 32 32)" opacity={0.6}>
          <path d="M32 14 A18 18 0 0 1 50 32"
                fill="none" stroke="url(#bm-stroke)" strokeWidth={2} strokeLinecap="round" />
          <animateTransform attributeName="transform" type="rotate"
            from="0 32 32" to="360 32 32" dur="6s" repeatCount="indefinite" />
        </g>

        {/* check */}
        <path d="M24 33 l7 7 14-18" fill="none" stroke="#fff" strokeWidth={5}
