...
export default function Home() {
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="mx-auto max-w-6xl px-3 py-10 md:py-12">
        <div className="grid items-center gap-6 md:grid-cols-2">
          <div>
            ...
            <p className="mt-2 text-sm text-slate-600 dark:text-slate-300">
              A focused board for people &amp; machines—drag, drop, filter, and export the daily plan.
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <a
                href="/pricing"
                className="inline-flex items-center justify-center rounded-md px-3 py-1 text-xs text-white bg-brand-500 hover:bg-brand-600 transition ring-focus"
              >
                Get started
              </a>
              <a
                href="/features"
                className="inline-flex items-center justify-center rounded-md px-3 py-1 text-xs border border-slate-300 text-slate-700 bg-white hover:bg-slate-50 transition dark:text-slate-200 dark:bg-slate-900 dark:border-slate-700 dark:hover:bg-slate-800 ring-focus"
              >
                See features
              </a>
            </div>
            ...
            <p className="mt-2 text-[11px] text-slate-500 dark:text-slate-400">
              No timekeeping, no payroll—just clean dispatch.
            </p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="pointer-events-none absolute -inset-10 -z-10 opacity-30 blur-3xl bg-gradient-to-tr from-sky-200 via-cyan-100 to-transparent dark:from-sky-900/30 dark:via-cyan-900/20 dark:to-transparent" />
          </div>
        </div>
      </div>
    </section>
