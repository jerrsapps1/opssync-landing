export default function Pricing() {
  ...
  return (
    <section className="container-ss py-8 md:py-10 space-y-6">
      <h1>Pricing</h1>
      <p className="text-sm muted">Simple per-user pricing. Start small, scale as you grow.</p>
      ...
      <div className="grid gap-3 md:grid-cols-4">
        <div className={card}>
          ...
          <ul className="space-y-1">
            ...
            <li className={li}>Exports</li>
          </ul>
          <a href="/contact" className="mt-2 inline-flex items-center rounded-md bg-slate-900 px-3 py-1 text-[12px] font-medium text-white dark:bg-slate-700 ring-focus">Choose Solo</a>
        </div>
        ...
        <div className={`${card} border-brand-500`}>
          ...
          <a href="/contact" className="mt-2 inline-flex items-center rounded-md bg-brand-500 px-3 py-1 text-[12px] font-medium text-white hover:bg-brand-600 ring-focus">Choose Team</a>
        </div>
        ...
        <div className={card}>
          ...
          <a href="/contact" className="mt-2 inline-flex items-center rounded-md bg-slate-900 px-3 py-1 text-[12px] font-medium text-white dark:bg-slate-700 ring-focus">Choose Crew</a>
        </div>
        ...
        <div className={card}>
          ...
          <a href="/contact" className="mt-2 inline-flex items-center rounded-md bg-slate-900 px-3 py-1 text-[12px] font-medium text-white dark:bg-slate-700 ring-focus">Choose Plus</a>
        </div>
      </div>

      <p className="text-[11px] muted">Need more seats or multi-org? <a href="/contact" className="underline">Contact us</a> for a custom plan.</p>
    </section>
  );
}
