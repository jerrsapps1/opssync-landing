  ...
  const tiers = [
    {
      ...
      price: "$29", unit: "/mo",
      features: ["1 seat", "Employee & Equipment board", "Timekeeping & exports", "Basic reports"],
    ...
    },
    {
      ...
      price: "$119", unit: "/mo",
      features: ["5 seats", "All Solo features", "Role-based permissions", "Project insights"],
    ...
    },
    {
      ...
      price: "$199", unit: "/mo",
      features: ["10 seats", "All Team 5 features", "Advanced exports & checks", "Priority support"],
    ...
    },
    {
      ...
      price: "$449", unit: "/mo",
      features: ["25 seats", "All Team 10 features", "SLA & onboarding support", "Custom export mappings"],
  ...
  return (
    <section className="mx-auto max-w-6xl px-6 py-12">
      <header className="text-center">
        ...
        <p className="mt-3 text-lg muted">Simple per-user tiers. Scale your team as projects ramp.</p>
      </header>
      ...
      <div className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {tiers.map((t) => (
          <div key={t.name} className={`card card-hover p-6 ${t.featured ? "border-2 border-brand-500" : ""}`}>
            ...
            <a
              href="#"
              className={`ring-focus mt-6 inline-flex items-center justify-center rounded-xl px-4 py-2 font-medium transition
                ${t.featured
