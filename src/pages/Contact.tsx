    ...
    <section className="container-ss py-8 md:py-10 space-y-6">
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <form className="card p-4 space-y-3">
          ...
          <button type="button" className="rounded-md bg-brand-500 px-3 py-1 text-[12px] font-medium text-white hover:bg-brand-600">
            Send message
          </button>
          <p className="text-[11px] muted">Demo form—wire up your email when ready.</p>
        </form>

        <div className="card p-4 space-y-2">
          <h2>OpsSync.ai</h2>
          <p className="text-sm muted">Built for construction &amp; demo operations—field and office in sync.</p>
